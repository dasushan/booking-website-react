...
import { setProperty } from '../store/userSlice';
...
const Details = () => {
  ...
  useEffect(() => {
    console.log(`${property} 2nd effect`)
        ...
        <div className="flex ">
          ...
          <div className="h-screen overflow-y-scroll flex-grow no-scrollbar">
            {filteredProperty.map((item) => {
              return (
                <div className="flex mb-3 gap-3 p-1 bg-slate-100 rounded-md">
